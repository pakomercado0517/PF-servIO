...
export default function EditUser() {
    ...
    console.log('user linea20', globalUser)
    ...
    function handleCheck(e){
        console.log("checked204",e.target.checked)
...
////----------------------------- edit cliente ------------------------------
                    <div className={s.container_edilt_form_pofcional}>
                        ...
                        <label>Seguir registrado como cliente:<input
                            type='checkbox'
                            id="checkboxClient"
                            checked=""
                            value='cliente'
                    ...
                    <div >
                        <p>Recuerda que los campos que no edites no se van a cambiar, lo unico que no podrás editar es el DNI.</p>  
                    </div>
